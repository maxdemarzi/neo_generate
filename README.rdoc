...
This Project allows you to quickly define a graph and generate nodes.csv and rels.csv.
These files will imported into the Neo4j using the Neo4j Batch Importer

* {NeoGenerate Blog Post}[http://maxdemarzi.com/2012/06]
...
* {Batch Importer - Repository}[https://github.com/jexp/batch-import]
...
Quick Steps:
  ...
  git clone https://github.com/jexp/batch-import
  cd batch-import
...
Step 2: Install this application
  ...
  rake neo4j:create
  rake neo4j:load
  Run command that is shown (doing this to peel away some of the magic)
  rake neo4j:start
  rake neo4j:index
